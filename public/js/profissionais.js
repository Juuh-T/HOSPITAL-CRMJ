...
//funcao pra verificar se o usuario tem permissao de estar aqui ou seja é admin
...
function js_autenticarQuemTaAqui(){
    ...
    //SE FOR ADMIN DAI SIM ELE CARREGA A PAGINA 
    .then( function ( dados ){
        if ( dados.administrador === true){
            alert("Seja bem vindo " + dados.nome)
            //se for admin carrega a pagina
            js_carregarProfissionais();
        }
        
            //SE N FOR ADMIN JA CAI FORA
        else {
